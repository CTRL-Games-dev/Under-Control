...
public class CardUI : MonoBehaviour
{
    ...
    public void OnPointerEnter() {
        AudioManager.instance.PlayOneShot(FMODEvents.instance._CardHover, this.transform.position);
    ...
    public void OnPointerExit() {
        AudioManager.instance.PlayOneShot(FMODEvents.instance._CardHoverExit, this.transform.position);
